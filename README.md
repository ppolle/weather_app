...
## Description
This is a web application that provides current waether of different cities around the globe. It uses the weather API.
...
To run the tests, run ``python manage.py test weatherApp``
